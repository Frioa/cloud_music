...
class _SearchClient implements SearchClient {
  ...
  Future<DataWrapResponse<DailySongResponse>> recommendSongs() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<DataWrapResponse<DailySongResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<RecommendSheetResponse> recommendResource() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RecommendSheetResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SongUrlResponse> songUrl(id) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SongUrlResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
