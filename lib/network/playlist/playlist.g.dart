...
class _PlaylistClient implements PlaylistClient {
  ...
  Future<PlayDetailResponse> playlist(id) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PlayDetailResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<TrackAllResponse> trackAll(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TrackAllResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<LyricResponse> lyric(id) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<LyricResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
