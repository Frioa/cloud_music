...
class _NestUserClient implements NestUserClient {
  ...
  Future<NestUserAccountResponse> userAccount() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NestUserAccountResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/user/account',
  ...
  Future<NestUserDetailResponse> userDetail() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NestUserDetailResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
  ...
  @override
  Future<NestUserRecordResponse> userRecord(uid, {type = 0}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'uid': uid, r'type': type};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NestUserRecordResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/user/record',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<UserSheetResponse> playlist(uid) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UserSheetResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/user/playlist',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
